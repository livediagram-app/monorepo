...
import { TelemetryToggle } from '@/components/illustrations/privacy';
...
<Figure caption="One switch in Settings turns telemetry off for your browser, whatever the deployment is set to.">
  <TelemetryToggle />
</Figure>

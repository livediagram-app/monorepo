...
import { PublicCode } from '@/components/illustrations/privacy';
...
<Figure caption="The whole codebase is public and MIT-licensed, so any privacy claim is something you can read for yourself.">
  <PublicCode />
</Figure>

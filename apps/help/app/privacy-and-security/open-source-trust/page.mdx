...
export const metadata = helpMetadata({ title: "Open Source and Trust", description: "livediagram is MIT-licensed with a public codebase, so you can audit exactly how it handles your data, or run your own copy.", path: "/help/privacy-and-security/open-source-trust/" });
...
<Tip>Whether you use the hosted version or run your own, you get the same feature set. The hosted site is a convenience, not a more capable product.</Tip>

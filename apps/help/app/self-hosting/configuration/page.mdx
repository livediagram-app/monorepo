...
import { ConfigSources, GuestFallback } from '@/components/illustrations/self-hosting';
...
<Figure caption="Each surface reads configuration at runtime, so no secrets ever live in the public source.">
  <ConfigSources />
</Figure>
...
<Figure caption="Whether Clerk is configured or not, requests resolve to a working editor.">
  <GuestFallback />
</Figure>

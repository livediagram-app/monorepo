...
export const metadata = helpMetadata({ title: "Self-Hosting Overview", description: "Why and how you can run your own copy of livediagram. It is MIT-licensed and runs entirely on Cloudflare.", path: "/help/self-hosting/self-hosting-overview/" });
...
<Tip>Ready to deploy? See [deploying livediagram](/help/self-hosting/deploying-livediagram/) for the shape of the apps, then [configuration and optional auth](/help/self-hosting/configuration/) for the settings you can turn on.</Tip>

...
The [Explorer](/help/explorer/the-explorer/) has a **Themes** entry under its Library section where you can manage them all in one place: each is shown as a preview card you can **Edit**, **Duplicate**, or **Delete**.

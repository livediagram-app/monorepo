...
export const metadata = helpMetadata({ title: "The Format Painter", description: "Copy one element's styling onto others in a single click with the format painter in livediagram.", path: "/help/tips-and-tricks/format-painter/" });

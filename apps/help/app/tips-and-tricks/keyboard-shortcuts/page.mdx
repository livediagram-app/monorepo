...
export const metadata = helpMetadata({ title: "Keyboard Shortcuts", description: "Find the keyboard shortcuts that speed up the livediagram editor, and learn how to turn them off if they get in your way.", path: "/help/tips-and-tricks/keyboard-shortcuts/" });
...
- `Z` to toggle [Zen mode](/help/features/zen-mode/) on and off, with `Escape` to exit it.

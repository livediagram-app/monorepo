...
A clean, consistent look does not have to mean fiddling with colours one element at a time. Pair a [theme](/help/customisation/themes/) for the whole tab with [style presets](/help/customisation/style-presets/) on the elements that matter, and a rough diagram becomes a polished one in seconds.

...
export const metadata = helpMetadata({ title: "The Command Palette", description: "The floating palette is where you pick tools and add shapes, icons, and components to your diagram in livediagram.", path: "/help/tips-and-tricks/command-palette/" });

...
<ArticleLayout title="The Command Palette" description="Pick tools and drop new elements onto the canvas from the floating palette that sits on top of your diagram." categoryTitle="Tips and Tricks" categorySlug="tips-and-tricks">

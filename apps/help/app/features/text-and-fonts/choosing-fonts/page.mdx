...
export const metadata = helpMetadata({
  ...
  path: "/help/features/text-and-fonts/choosing-fonts/",
});
...
<Tip>Text stays visible in a fallback face while a font loads, so your diagram is always readable, even offline or where Google Fonts is blocked.</Tip>

...
export const metadata = helpMetadata({
  ...
  path: "/help/features/shapes-and-arrows/arrow-to-arrow/",
});
...
<ArticleLayout
  ...
  subArticles={getSubArticles("shapes-and-arrows").filter((a) => a.slug !== "arrow-to-arrow")}
>
...
<Tip>For a sequence diagram, draw your lifelines first as long vertical arrows, then draw each message across them, the snap points make it easy to keep messages evenly spaced down the page.</Tip>

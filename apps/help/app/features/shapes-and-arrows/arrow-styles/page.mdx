...
export const metadata = helpMetadata({
  ...
  path: "/help/features/shapes-and-arrows/arrow-styles/",
});
...
- **Line style** picks the geometry: **Straight** (a single line), **Curved** (a gentle bezier bow), or **Angled** (an axis-aligned L-shaped elbow). Curved and angled lines expose a draggable handle so you can shape the path by hand, covered in [Curve and elbow handles](/help/features/shapes-and-arrows/curve-and-elbow-handles/).
...
<Tip>The label colour defaults to the arrow's stroke colour, so it matches the line automatically until you choose otherwise.</Tip>

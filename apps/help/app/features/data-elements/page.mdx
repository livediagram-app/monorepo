...
export const metadata = helpMetadata({ title: "Data and Chart Elements", description: "Show numbers visually with progress bars, donut rings, star ratings, pie charts, and timeline rails.", path: "/help/features/data-elements/" });

<ArticleLayout title="Data and Chart Elements" description="Turn plain numbers into something you can read at a glance, right on the canvas." categoryTitle="Features" categorySlug="features" subArticles={getSubArticles("data-elements")}>
...
- **Progress bars and rings** show a single 0 to 100 percentage as a filling bar or a donut ring, with optional fill, pulse, or stripe animations. See [Progress Bars and Rings](/help/features/data-elements/progress-elements/).
- **Rating** shows a one to five score as a row of stars, in an amber accent, with star-specific entrance and idle animations. See [Rating](/help/features/data-elements/rating/).
- **Pie chart** splits a total into slices you edit as label and value rows, drawn in your theme's colours. See [Pie Chart](/help/features/data-elements/pie-chart/).
...
<Tip>Mix data elements with regular shapes and arrows to annotate a system map: drop a progress ring next to a service to show its rollout, or a rating beside an option you're comparing.</Tip>

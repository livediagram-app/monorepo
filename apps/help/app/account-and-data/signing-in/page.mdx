...
export const metadata = helpMetadata({ title: "Signing In", description: "Signing in to livediagram is optional and free. Learn what an account adds and how your guest diagrams move across.", path: "/help/account-and-data/signing-in/" });

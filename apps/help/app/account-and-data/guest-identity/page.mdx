...
export const metadata = helpMetadata({ title: "How Guest Identity Works", description: "Understand how livediagram identifies you as a guest with a per-browser id, and what that means for your diagrams.", path: "/help/account-and-data/guest-identity/" });

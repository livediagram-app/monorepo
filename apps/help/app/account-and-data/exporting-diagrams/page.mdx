...
export const metadata = helpMetadata({ title: "Exporting Diagrams", description: "Get your livediagram out of the app as an image, or embed a read-only live view elsewhere.", path: "/help/account-and-data/exporting-diagrams/" });
...
When you want the diagram to keep updating wherever it lives, [embed it](/help/features/sharing/embeds/) instead. An embed is a read-only iframe of a shared diagram that you can drop into Notion, a wiki, or any doc that accepts an iframe.

...
import { AiPanel, AiBuild } from '@/components/illustrations/tools';
...
<Figure caption="All four modes share one prompt box; the tabs at the top switch between them.">
  <AiPanel />
</Figure>
...
<Figure caption="Build turns a short prompt into a fresh, connected diagram that the editor lays out for you.">
  <AiBuild />
</Figure>

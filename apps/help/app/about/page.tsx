...
export default function AboutPage() {
  ...
  return (
    <div>
      <Breadcrumb items={[{ label: 'About livediagram' }]} />
      <div className="mx-auto max-w-7xl px-4 py-8 md:px-8">
        <h1 className="mb-2 text-3xl font-bold text-slate-900 md:text-4xl">About livediagram</h1>
        <p className="mb-8 text-base leading-relaxed text-slate-500 md:text-lg">
          What livediagram is, who it is for, and why it exists.
        </p>

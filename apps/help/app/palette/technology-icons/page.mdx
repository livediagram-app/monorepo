...
export const metadata = helpMetadata({
  ...
  path: '/help/palette/technology-icons/',
});

<ArticleLayout title="Technology Icons" description="Brand icons for the services people put on system-architecture diagrams, in their official colours." categoryTitle="Palette" categorySlug="palette" subArticles={getSubArticles("technology-icons")}>

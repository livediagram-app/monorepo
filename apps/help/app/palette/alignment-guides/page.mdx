...
import { PaletteSettings, AlignmentGuides } from '@/components/illustrations/palette-modes';
...
<Figure caption="The palette settings popover, with Alignment guides highlighted and switched on.">
  <PaletteSettings highlight="guides" />
</Figure>
...
<Figure caption="Snap lines appear as a shape is dragged into line with the edges and centres of its neighbours.">
  <AlignmentGuides />
</Figure>

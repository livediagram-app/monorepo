...
Alignment Guides is a toggle, and it is on by default. You will find it behind the gear (settings) icon in the header of the floating command palette, which opens a small settings popover.

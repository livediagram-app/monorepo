...
export const metadata = helpMetadata({
  ...
  path: '/help/palette/images/',
});

<ArticleLayout title="Images" description="Add screenshots, photos, and mockups to a diagram. Upload a file once, then reuse it across diagrams from your personal gallery." categoryTitle="Palette" categorySlug="palette" subArticles={getSubArticles("images")}>

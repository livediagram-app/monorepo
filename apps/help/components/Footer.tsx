...
// Help-centre footer. Mirrors the marketing footer's shape + links so the
// site feels of-a-piece. Links are same-origin absolute paths.
export function Footer() {
  return (
    <footer className="mt-16 border-t border-slate-200 bg-white">
      <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-6 px-4 py-10 sm:flex-row sm:items-center md:px-8">
        <div>
          <Brand size="sm" />
        ...
        >
          ...
          <a href="/help/features/" className="hover:text-slate-900">
            Features
          </a>
          <a href="/help/contact/" className="hover:text-slate-900">
            Contact
          </a>
      ...
      <div className="border-t border-slate-100">
        <div className="mx-auto max-w-7xl px-4 py-4 text-xs text-slate-400 md:px-8">

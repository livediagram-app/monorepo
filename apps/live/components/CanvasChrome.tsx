...
export function CanvasChrome(props: CanvasChromeProps) {
  ...
  return (
    <>
      ...
      {/* Top-centre chrome (spec/09): the owner / role badge, the active
          editor-mode banner + multi-selection toolbar, the session timer
          and the vote banner flow as one centred, non-overlapping column.
          The banner / toolbar and the timer share a row, so they sit
          alongside on desktop and wrap underneath on mobile. */}
      <TopCenterStack>

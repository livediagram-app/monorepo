...
- **Swimlane flowchart** _(Flowcharts)_ — a process across three role lanes (frame containers with a left role label): place-order → review → approve? → ship, with arrows crossing lanes to show the hand-offs.

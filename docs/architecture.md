...
| ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| `apps/marketing` | The landing site at `/`. Pure static HTML built with `next export`. Hero, per-category feature advertising blocks linking to a feature index (`/features`) + one detail page per category (`/features/<id>`), FAQ, legal, comparison pages.                                                                                                                                                         | `livediagram-marketing` |
